...
import { aboutUsOfJK,ourMissionOfJK, whatWeDoJK, ourValuesOfJK } from '@/app/constants'
...
function page() {
  return (
    <div className='overflow-hidden  lg:space-y-6 bg-white'>
      ...
      <div className="bg-brand px-4 md:space-y-14 md:px-14 md:py-5 py-4 space-y-14">
