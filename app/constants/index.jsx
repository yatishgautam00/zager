export const startingFeatures = [
  "Integrity: We uphold the highest standards of honesty and transparency in every interaction.",
  "Innovation: We continuously explore new technologies and methodologies to offer creative and effective solutions.",
  "Excellence:  We are committed to delivering outstanding results and exceeding client expectations.",
];
...
export const ourValuesGyan = [
  "Engagement: We value our community and strive to create content that sparks meaningful conversations and connections.",
  "Innovation: We embrace new ideas and formats to deliver fresh and engaging content that meets the evolving needs of our audience.",
  "Integrity: We are committed to providing accurate and reliable content, maintaining the highest standards of journalistic integrity.",
];

export const ourMissionOfGyan =
...
export const WhyChooseUsJK = [
  {
    title: "Expertise",
    description:
      "Our team of experienced professionals brings a wealth of knowledge and skill to every project, ensuring exceptional results.",
    icon: (
      <svg
        className="size-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "From video production and digital ads to media consulting and research, we offer a full suite of services to meet all your media needs.",
    icon: (
      <svg
        className="size-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "We tailor our services to fit your unique needs and objectives, providing personalized solutions that deliver real value.",
    icon: (
      <svg
        className="size-5"
        fill="none"
